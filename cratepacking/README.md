...
For instance, if the crate is size X = 25 by Y = 18, and the boxes are size x = 6 by y = 5, then the answer is 12. You can fit 4 boxes along the x-axis (because 64 <= 25), and 3 boxes along the y-axis (because 53 <= 18), so in total you can fit 4*3 = 12 boxes in a rectangle.
